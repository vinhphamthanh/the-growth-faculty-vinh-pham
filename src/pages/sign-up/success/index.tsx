	...
	return (
		<main className="w-full flex items-center py-5 justify-center">
			<div className="flex flex-col justify-center items-center px-3 md:px-0 w-full md:w-3/5 p-6">
				...
				<p className="w-full text-center mb-5"><span className="font-bold">Order Ref.</span> {generateOrderRef()} <span
					className="uppercase text-white bg-green-500 rounded-full py-2 px-4 mx-2 font-bold text-xs"
				>Bonus</span> </p>
				<button
